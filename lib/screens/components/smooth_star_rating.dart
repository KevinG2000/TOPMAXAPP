    ...
    return GestureDetector(
      ...
      onHorizontalDragUpdate: (dragDetails) {
        ...
        if (box != null) {
          ...
          Offset localPos = box.globalToLocal(dragDetails.globalPosition);

          // Calculate the relative position within the box
          double i = localPos.dx / box.size.width;
          var newRating = allowHalfRating ? i : i.round().toDouble();

          // Clamp the new rating to be within the star count range
          newRating = newRating.clamp(0.0, starCount.toDouble());

          // Call the onRatingChanged callback if provided
