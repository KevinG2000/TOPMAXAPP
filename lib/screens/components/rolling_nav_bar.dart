...
//     this.iconSize = 20,
//     this.iconText,
//     this.indicatorColors = Colors.pink,
//     this.indicatorCornerRadius = 10,
//     this.indicatorRadius = 25,
//     this.indicatorSides = 6,
//     this.navBarDecoration,
...
//   late int widgetActiveIndex;
//   late Color indicatorColor;
//
//   late AnimationInfo animationInfo;
//   late AnimationUpdate animationUpdate;
//
...
//   late double indicatorRotation; // in radians
//   late double indicatorX;
//   late double sidesPerListItem;
//
//   // Controllers for any `AnimationType`
//   late AnimationController indicatorAnimationController;
//   late Animation<double> indicatorAnimationTween;
//
//   @override
//   void initState() {
//     super.initState();
