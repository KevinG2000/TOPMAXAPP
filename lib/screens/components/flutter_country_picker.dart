...
Future<List<Country>> _fetchLocalizedCountryNames() async {
  ...
  // renamed.sort((Country a, Country b) => removeDiacritics(a.name).compareTo(b.name));
...
class CountryPicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (displayCountry == null) {
      displayCountry = Country.findByIsoCode(Localizations.localeOf(context).countryCode ?? "88");
    }
